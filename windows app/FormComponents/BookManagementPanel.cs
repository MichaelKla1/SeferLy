...
namespace WindowsFormsApplication2.FormComponents
{
    ...
    {
        private bool addBBookOpened = false;
        private bool editBookOpened = false;
        private AddBookPanel aup = null;
        private EditBookPanel eup = null;
        public BookManagementPanel(AddBookPanel aup, EditBookPanel eup)
        {
            this.aup = aup;
            this.eup = eup;
            InitializeComponent();
        ...
        {
            aup.Location = new Point(label1.Width, label1.Location.Y + label1.Height + 5);
