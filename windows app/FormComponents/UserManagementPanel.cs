...
namespace WindowsFormsApplication2.FormComponents
{
    ...
    {
        private bool addUserOpened = false;
        private bool editUserOpened = false;
        private AddUserPanel aup = null;
        private EditUserPanel eup = null;
        public UserManagementPanel(AddUserPanel aup,EditUserPanel eup)
        {
            this.aup = aup;
            this.eup = eup;
            InitializeComponent();
        ...
        {
            aup.Location = new Point(label1.Location.X+label1.Width-aup.Width, label1.Location.Y + label1.Height + 5);
